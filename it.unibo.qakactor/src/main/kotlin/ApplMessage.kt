...
open class ApplMessage:  IApplMessage{//ApplMessage
    ...
    override fun equals(other: Any?): Boolean {
        ...
        other as ApplMessage

        if (msgId != other.msgId) return false
        if (msgType != other.msgType) return false
        if (msgSender != other.msgSender) return false
        if (msgReceiver != other.msgReceiver) return false
    ...
    override fun hashCode(): Int {
        ...
        result = 31 * result + msgSender.hashCode()
        result = 31 * result + msgReceiver.hashCode()
        result = 31 * result + msgContent.hashCode()
