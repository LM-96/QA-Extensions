 ...
 * present in the passed [initialParams] argument. Notice that the result **copy** all the
 * elements in the given map to an internal map. So, all the modification done to the
